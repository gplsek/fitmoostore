        ...
        <section class="mailtext">
            <div class="section-wrapper clearfix">
                <div class="content-div">
                    <p>Your Item has arrived. If satified with your purchase please accept the order on your dashboard. <a href="<?php print $redirect_base;?>/dashboard/orders/<?php print $orderID;?>">Your order</a> on Fitmoo.com </p>
                </div>
